 ...
 *
 */
public class FreeRangeAgent extends MobileAgent {

	private static final long serialVersionUID = 1L;
	
	public double myLastSpeed = -1; // recordkeeping
	public double minSpeed = -1;
	public double spatialResolution = 5;
	
	public FreeRangeAgent(double spatialResolution){ 
		super();
		this.spatialResolution = spatialResolution;
	}
	
	public FreeRangeAgent(Coordinate c, double spatialResolution){ 
		super((new GeometryFactory()).createPoint(c));
		this.spatialResolution = spatialResolution;
	}
	
	public FreeRangeAgent(Point p, double spatialResolution){ 
		super(p); 
		this.spatialResolution = spatialResolution;
	}
	...
	public boolean arrived(){
		return (this.goalPoint.distance(this.geometry.getCoordinate()) < spatialResolution);
	}
